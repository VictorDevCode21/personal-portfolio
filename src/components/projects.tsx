...
function Projects() {
    ...
    return (
        <section id='projects' className='w-full h-screen bg-blue-bg flex flex-col justify-center items-center '>
            ...
            <div className='relative w-full '>
                <div className=" inset-0 flex items-center justify-between ">
                    <button
                        onClick={prev}
                        className="p-1 rounded-full shadow text-gray-800 hover:bg-light-blue hover:text-black absolute bottom-64 left-6"
                    >
                        <BsChevronLeft size={40} />
                    </button>
                    <button
                        onClick={next}
                        className="p-1 rounded-full shadow text-gray-800 hover:bg-light-blue hover:text-black absolute bottom-64 right-6"
                    >
